                  ...
                  <tr key={link.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                      <div className="flex items-center space-x-2">
                        ...
                        <button
                          onClick={() => copyToClipboard(link.public_url, link.link_code)}
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="flex items-center space-x-2">
                    <input
                      type="text"
                      value={selectedLink.public_url}
                      readOnly
                      className="flex-1 px-2 py-1 border border-gray-300 rounded text-sm font-mono bg-gray-50"
                    />
                    <button
                      onClick={() => copyToClipboard(selectedLink.public_url, selectedLink.link_code)}
