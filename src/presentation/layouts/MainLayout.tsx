      ...
      <header className="bg-white shadow-sm">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          <div className="flex items-center">
            <Link to="/" className="text-xl font-bold text-primary-600">B-Commerce</Link>
          </div>
          ...
          <div className="flex items-center space-x-4">
            ...
            <Link to="/register" className="px-4 py-2 bg-primary-600 text-white rounded-md hover:bg-primary-700 transition-colors">Register</Link>
          </div>
        </div>
      </header>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-lg font-semibold mb-4">B-Commerce</h3>
              <p className="text-gray-400">Your one-stop e-commerce solution for all your shopping needs.</p>
            </div>
          ...
          <div className="mt-8 pt-8 border-t border-gray-800 text-center text-gray-400">
            <p>&copy; {new Date().getFullYear()} B-Commerce. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
